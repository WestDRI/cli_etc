...
#+BEGIN_note
Example:\\
{{<m>}} ~**/foo~ matches file or directory {{<b>}}foo{{</b>}} anywhere. This is the same as ~foo~.
#+END_note
...
#+BEGIN_note
Example:\\
{{<m>}} ~abc/**~ matches all files (recursively) inside directory {{<b>}}abc{{</b>}}
#+END_note
...
#+BEGIN_note
Example:\\
{{<m>}} ~a/**/b~ matches {{<b>}}a/b{{</b>}}, {{<b>}}a/x/b{{</b>}}, and {{<b>}}a/x/y/b{{</b>}}
#+END_note

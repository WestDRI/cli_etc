...
[[https://westgrid-cli.netlify.app/summerschool2020/git-09-history.html][In the last lesson]], you learnt how to explore your Git history. In this lesson, I'd like to show you two great open-source tools which allow to do so in a nice visual manner while remaining in the command line.

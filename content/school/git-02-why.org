...
[[https://westgrid-cli.netlify.app/school/git-12-branches.html][Branches]] provide an easy way to experiment with a project without risking to mess up the stable branch; or to have several developments happening in parallel.

...
The [tidyverse](https://www.tidyverse.org/){target="_blank"} is a set of packages which attempts to make R more consistent and more similar to programming languages which were developed by computer scientists rather than statisticians.
...
This introductory workshop is much too short to get into the syntax and usage of the tidyverse, but this series of cheatsheet developed by [Posit](https://posit.co/){target="_blank"} can give you a bird's eye view of the tidyverse.
